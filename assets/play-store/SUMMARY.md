# 📱 Google Play Store Feature Graphic - Quick Summary
...
1. Choose a template design you like
2. Take a screenshot or recreate in design software
3. Export at 1024 x 500px as PNG (no transparency)
4. Save as `feature-graphic.png` in this folder

### Option 2: Design from Scratch

1. **Open design tool** (Figma, Photoshop, Canva)
2. **Create canvas**: 1024 x 500 px
3. **Design your graphic**:
   - Use your logo from `assets/logo.svg`
   - Add app name: "يومي في رمضان"
   - Add tagline: "Your Complete Ramadan Companion"
   - Keep content 50px from edges (80px for text)
4. **Export as PNG** (no transparency)
5. **Save to**: `assets/play-store/feature-graphic.png`
...
- [ ] Content is within safe zones
- [ ] Tested on mobile device preview

## 🔗 Upload Location

**Google Play Console** → **Store presence** → **Main store listing** → **Graphics** → **Feature graphic**
...
4. I can provide more specific guidance or help generate the graphic

---

**Files Location**: `assets/play-store/`
**Main Guide**: `PLAY_STORE_ASSETS.md`
**Template**: `feature-graphic-template.html`
